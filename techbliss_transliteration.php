...
/*
Plugin Name: WP Google Lang Transliteration
...
Version: 1.0
Authors: India Fascinates Dot Com and Rajesh - Techblissonline Dot Com
Author URIs: India Fascinates(http://indiafascinates.com/)and Rajesh (http://techblissonline.com/)
*/
...
class WPGoogleLangTransliteration {
    ...
    ?>
		...
		<input style="width:15px;" type="checkbox" id="checkboxId" onclick="javascript:checkboxClickHandler()"></input><select style="width:100px;" id="languageDropDown" onchange="javascript:languageChangeHandler()"></select>&nbsp;&nbsp;<small>(Transliteration options! What is this? Find out <a href="http://indiafascinates.com/wp-google-language-transliteration-plugin/" target="_blank">here</a>)</small>
		</div>
		<div id="errorDiv"></div>
		<?php } else { ?>
...
<?php
    ...
    <script type="text/javascript">
      ...
      function onLoad() {		
		...
		var ids = [ "content", "title", "newtag", "newcat" , "excerpt", "metakeyinput" , "metavalue" , "post_password"];
	...
	function init() {
		...
		wp_enqueue_script('WPGoogletransliterategeneral-js', WP_PLUGIN_URL . '/WPTransliteration/transliterate.js');	
	...
	{
	?>
		<small>Lingual Support by <a href="http://indiafascinates.com/" target="_blank">India Fascinates</a>, <a href="http://techblissonline.com/" target="_blank">Techblissonline</a> and <a href="http://www.google.com/transliterate/indic" target="_blank">Google</a></small>
	<?php	
	}
}	//end class
}   //end if
